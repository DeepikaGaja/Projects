...
const AddBooks = () => {
  ...
  return (
    <form className='md:w-1/2 w-full font-Poppins p-12 mx-auto' onSubmit={handleSubmit}>
      <h2 className='font-semibold text-2xl mb-4 text-center'>Add a new Book</h2>
      <div className='mb-4'>
        <label className='font-medium text-lg text-gray-600 mb-2'>Title</label>
        <input type="text" name='title' value={bookData.title} onChange={handleChange} placeholder='Enter a Title' className='w-full h-12 pl-2 pr-5 border-2 border-black outline-none' />
      </div>
      <div className='mb-4'>
      ...
      <div className='mb-4'>
        ...
        <input type="text" name='type' value={bookData.type} onChange={handleChange} placeholder='Enter a book type' className='w-full h-12 pl-2 pr-5 border-2 border-black outline-none' />
      </div>
      <div className='mb-4'>
